...
(defn stop-ntp!
  []
  (c/su
    (try (c/exec :service :ntp :stop) (catch Exception e))
    (try (c/exec :service :chrony :stop) (catch Exception e))
    (try (c/exec :service :systemd-timesyncd :stop) (catch Exception e))))
